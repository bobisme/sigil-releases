...
```sh
curl -fsSL https://github.com/bobisme/sigil-releases/releases/download/v0.33.1/sigil-installer.sh | sh
```

Replace `v0.33.1` with the version you want. Pick one from the
