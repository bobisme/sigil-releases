...
```sh
curl -fsSL https://github.com/bobisme/sigil-releases/releases/download/v0.32.1/sigil-installer.sh | sh
```

Replace `v0.32.1` with the version you want. Pick one from the
