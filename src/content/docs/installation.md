...
```sh
curl -fsSL https://github.com/bobisme/sigil-releases/releases/download/v0.30.0/sigil-installer.sh | sh
```

Replace `v0.30.0` with the version you want. Pick one from the
