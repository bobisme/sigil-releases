...
```sh
curl -fsSL https://github.com/bobisme/sigil-releases/releases/download/v0.32.5/sigil-installer.sh | sh
```

Replace `v0.32.5` with the version you want. Pick one from the
