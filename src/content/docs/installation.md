...
```sh
curl -fsSL https://github.com/bobisme/sigil-releases/releases/download/v0.33.2/sigil-installer.sh | sh
```

Replace `v0.33.2` with the version you want. Pick one from the
